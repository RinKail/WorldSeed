...
#define LOCTEXT_NAMESPACE "FWorldSeedModule"
...
void FWorldSeedModule::ShutdownModule()
{
	...
	FEditorModeRegistry::Get().UnregisterMode(FWorldSeedEdMode::EM_WorldSeedEdModeId);
}

#undef LOCTEXT_NAMESPACE
	
IMPLEMENT_MODULE(FWorldSeedModule, WorldSeed)